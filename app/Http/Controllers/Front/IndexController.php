...
class IndexController extends Controller
{
    ...
    public function getSkills ()
    {
        return [
            ...
            ['name' => 'Laravel',       'filter' => 'filter-frameworks', 'image' => asset('assets/img/skills/laravel.png'), 'description' => 'PHP framework for building robust applications.', 'width' => '150px'],
            ...
            ['name' => 'Razorpay',      'filter' => 'filter-apis', 'image' => asset('assets/img/skills/razorpay.png'), 'description' => 'Payment gateway for Indian businesses.', 'width' => '125px'],
            ['name' => 'CC Avenue',     'filter' => 'filter-apis', 'image' => asset('assets/img/skills/ccavenue.png'), 'description' => 'Secure payment gateway for online businesses.', 'width' => '125px'],
            ...
            ['name' => 'AusPost',       'filter' => 'filter-apis', 'image' => asset('assets/img/skills/auspost.png'), 'description' => 'Australia Post shipping integration.', 'width' => '125px'],
            ...
            // Other Technologies
            ['name' => 'Shopify',       'filter' => 'filter-other', 'image' => asset('assets/img/skills/shopify.png'), 'description' => 'E-commerce platform for online stores.', 'width' => '125px'],
            ...
            ['name' => 'Proofhub',      'filter' => 'filter-other', 'image' => asset('assets/img/skills/proofhub.png'), 'description' => 'Project management and team collaboration software for managing tasks, projects, and communication.'],
            ['name' => 'Jira Software', 'filter' => 'filter-other', 'image' => asset('assets/img/skills/jira.png'), 'description' => 'Project management and team collaboration software for managing tasks, projects, and communication.', 'width' => '150px'],
